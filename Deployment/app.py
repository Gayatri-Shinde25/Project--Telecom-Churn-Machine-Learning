...
import joblib
model = joblib.load("C:/Users/User/PycharmProjects/pythonProject/pythonProject/Churn Prediction/model.sav")
...
def main():
    ...
    st.title('Customer Churn Prediction App- Telecom Industry')

    # Setting Application description
    st.markdown("""
        :dart:  The ability to identify customers that aren’t happy with provided solutions allows businesses to learn about product or pricing plan weak points, operation issues, as well as customer preferences and expectations to proactively reduce reasons for churn.
    ...
    st.markdown(
           ...
           <style>
           body {
               font-family: Congenial Black, Cambria Math;
               background-color: #C8A2C8; /* Example color code */
           }
           </style>
           """,
